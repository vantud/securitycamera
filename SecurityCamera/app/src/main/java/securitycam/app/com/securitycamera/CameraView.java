...
public class CameraView extends Activity implements SurfaceHolder.Callback,
    ...
    public void onCreate(Bundle icicle) {
        ...
        Log.e(TAG, "onCreate");
        SharedPreferences appPrefs = CameraView.this.getSharedPreferences("appPreferences", CameraView.this.MODE_PRIVATE);
        int size = Integer.parseInt(appPrefs.getString("prefSizeImage", "")); //load size ảnh
        setContentView(R.layout.activity_camera_view);
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            if(data != null) {
                ...
                try {
                    ...
                    resizedBitmap.compress(Bitmap.CompressFormat.JPEG, 60,
                            bytes);
